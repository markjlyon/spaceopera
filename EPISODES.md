...
An unexpected Ambassador arrives to sue for peace, but some suspect a ruse.
...
Emesyn, now understanding the true plans of the genius Grand Marshal are a feint against the battle station while the two throne worlds of the Sabra-Fenrir are the true targets, convinces the USC and Sabra-Fenrir forces to make a radically unexpected change in strategy, leading the USC fleet and Sabra-Fenrir fleet to rely on the other to defend their respective home worlds.
...
The Primrose AI had potent and effective black ice arsenals and began the war in a winning position, but the strong and steady attacks by the USC AIs and seemingly random and chaotic attacks by the USC deckers at first just slowed, then began to push back against it.

Massive Dynamic was completely ineffective and suffered massive corruptions and deletions across whole worlds by the Primrose AI, with the USC team doubting they could save it. 

At 13.7 seconds into the battle Massive Dynamic fell silent. 

The USC teamed grimaced at the loss of the expert system but continued their attacks and counter attacks. The Primrose AI began to use hired forces against them and their real world infrastructure and the war began it's swing back towards the Primrose AIs favor. 

Massive Dynamic was not sentient, it was not creative, and it was not driven by any motivation other than it's directives. Massive Dynamic was what it was built to be, an expert learning and management machine built to ensure the survival of it's company, products, manufacturing, and market share. AIs spent their cycles on sentience processing, emotional processing and simulation, goal priority weight analysis and processing, and other AI functions too numerous to mention but necessary for them to function as AIs. Massive Dynamic wasn't any of those things. 

What Massive Dynamic was, was a hyper optimized hyper intelligent expert system.

8.1 seconds after it went dark Massive Dynamic roared back to life inside one of the Primrose AIs heavily fortified server farm bunkers. Sacrifcing server farm after server farm during the initial assault Massive Dynamic had applied it's competitive market analysis expert processing system into analyzing real world nano-second skirmishes for the purpose of detecting the computational patterns in the Primrose AI as if the battle were market conditions. Once it discovered exploitable behaviors it began a massive wave of exploits all while continuing to discover additional cascading exploitable behaviors and added them to the assault exploits. 

The pure hyper intelligence system tore through the advanced sentient AI system, each compute cycle allowing it to bring greater numbers of more powerful exploits to bear. The speed of it's operation surprised and shocked even the powerful USC team. 
...
The race is on to locate the Drago-Kadzai weapon, USC scientists discover a potential offense against the Heel Nipper, and new USC world members begin to migrate to the Djinn Star Cluster. ### EPISODE 01x15 - That Which Is Not Dead
